...
# Author	  : William
# Date		: 2018/08/22
# Update by: Le Sanglier des Ardennes
...
def loop():					  #GUI
	...
	while True:
		...
		Btn0.place(x=30,y=450) # Forward
		Btn1.place(x=300,y=450) # Backward
		Btn2.place(x=30,y=550) # Left
		Btn3.place(x=300,y=550) # Right
		...
		Btn4.place(x=30,y=650)
		Btn5.place(x=300,y=650)
		...
		Btn14.place(x=30,y=110)						  #Define a Button and put it in position
